...
import { useAtributoCrearForm } from '../../hooks/useForms'

interface AtributoCrearModalProps {
  tipoAtributoId: number
  visible: boolean
  onClose: () => void
}

export const AtributoCrearModal = ({ tipoAtributoId, visible, onClose }: AtributoCrearModalProps) => {
  const {
    handleChange,
    handleBlur,
    handleSubmit,
    ...
    touched,
    enProceso,
  } = useAtributoCrearForm(tipoAtributoId)
